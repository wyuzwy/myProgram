                ...
                <div class="container-fluid">
                    <div style="margin: 20px">
                        <form class=" form-inline"  id="form-search">
                            ...
                            <span> &nbsp </span>
                            <label class="form-inline">审核状态</label>
    ...
    <div class="modal-dialog" style="width: 900px">
        <div class="modal-content">
            ...
            <div class="modal-body" >
                <div style="margin: 20px;height: 900px;">
                    ...
                    <form  class="col-md-9 form-horizontal"  id="update_preach" >
                        ...
                        <div class="form-group" id="preach_remark" hidden>
                            <label class="col-sm-2 control-label">原因：</label>
                            <div class="col-sm-4">
                                <textarea cols="50" rows="2" id="preachRemark" readonly></textarea>
                            </div>
                        </div>
    ...
    <div class="modal-dialog" style="width: 900px">
        <div class="modal-content">
            ...
            <div class="modal-body" >
                ...
                <div style="margin: 20px;height: 1100px;">
                    <form  class="col-md-9 form-horizontal"  id="update_job" >
                        ...
                        <div class="form-group" id="job_remark" hidden>
                            <label class="col-sm-2 control-label">原因：</label>
                            <div class="col-sm-4">
                                <textarea cols="50" rows="2" id="jobRemark" readonly></textarea>
                            </div>
                        </div>
                        <div class="form-group" hidden>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" onclick="downLoadResume()" id="downLoadResume">
                    下载简历
                </button>
...
<script type="text/javascript">
    ...
    function downLoadResume() {
        var id = $("#jobId").val();
        if(id==""||id==undefined){
            layer.msg('请重新加载页面！', {icon: 2});
            return false;
        }
        window.location.href="file/downLoadResume?id="+id;
    }
    ...
    function show_one_preach(preach) {
        ...
        if(preach.status=="2"){
            $("#preach_remark").show();
            $("#preachRemark").val(preach.remark);
        }
    }
    ...
    function updatePreach() {
        ...
        layer.confirm("修改后状态默认为审核中，是否确认修改宣讲会？",{btn:['确定','取消'],title:"提示"},function () {
            ...
            $.ajax({
                ...
                success:function (result) {
                    if(result.flag=="200"){
                        layer.msg('修改成功！请等待管理员审核', {icon: 1});
    ...
    function updateJob() {
        ...
        layer.confirm("修改后状态默认为审核中，是否确认修改？",{btn:['确定','取消'],title:"提示"},function () {
            $.ajax({
    ...
    function show_preach(page) {
        ...
        var data="rows=5&page="+page+"&sendId="+value+"&status="+status;
    ...
    function build_preach_table(result){
        ...
        $.each(preach, function (index, res) {
            ...
            var sup ;
            if(res.status=="0"){
                sup =$("<font style=\"background-color: red\" color='white' >审核中</font>");
            }else if(res.status=="1"){
                sup = $("<font style=\"background-color: blue\" color='white' >通过</font>");
            }else if(res.status=="2"){
                sup =$("<font style=\"background-color: black\" color='white' >不通过</font>");
            }else{
