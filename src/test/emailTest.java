...
//    }
    ...
    @Test
    public void  tets(){
        String str = "AQECUBXSRUNUABXA";//QVFFQ1VCWFNSVU5VQUJYQQ==
    ...
    @Test
    public void  tets2(){
        byte[] decoded = Base64.getDecoder().decode("QVFFQ1VCWFNSVU5VQUJYQQ==");
...
//        String name = "/resumes/2020032422/0864bJAVA后端开发_张文宇.pdf";
//        String name = "";
